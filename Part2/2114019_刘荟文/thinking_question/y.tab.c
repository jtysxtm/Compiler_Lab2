...
修改词法分析程序，能识别变量(标识符)和"="符号，
修改语法分析器，使之能分析、翻译"a=2"形式的(或更复杂的, “a=表达式")赋值语句，
当变量出现在表达式中时，能正确获取其值进行计算(未赋值的变量取O)。
当然，这些都需要实现符号表功能。
...
static const char *const yytname[] =
{
  ...
  "DIV", "UMINUS", "LEFT", "RIGHT", "NUMBER", "IDENTIFIER", "ASSIGN",
  "SEMI", "END", "$accept", "program", "stmt", "expr", YY_NULLPTR
};
...
{
     -10,    -6,     0,   -11,    16,   -11,   -11,   -11,    16,    16,
     -11,   -11,    -1,   -11,    25,    16,    16,    16,    16,   -11,
     -11,     2,     2,   -11,   -11
};
...
{
       5,     1,    15,    16,    17,    18,     4,    17,    18,    13,
      14,     1,    19,     7,     6,     0,    21,    22,    23,    24,
       8,     0,     0,     0,     9,     0,    10,    11,    15,    16,
      17,    18,     0,     0,    20
};

static const yytype_int8 yycheck[] =
{
       0,    11,     3,     4,     5,     6,    12,     5,     6,     8,
       9,    11,    13,     2,    14,    -1,    15,    16,    17,    18,
       4,    -1,    -1,    -1,     8,    -1,    10,    11,     3,     4,
       5,     6,    -1,    -1,     9
};
...
{
       0,    11,    16,    17,    12,     0,    14,    17,     4,     8,
      10,    11,    18,    18,    18,     3,     4,     5,     6,    13,
       9,    18,    18,    18,    18
};
